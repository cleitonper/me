...
describe('Component: Skills', () => {
  it('should render skills', () => {
    const props: Props = {
      skills: [
        { order: 1, title: 'My Title 1', description: 'My Description 1', icon: { pack: 'fas', name: 'server' }, tools: ['1', '2'] },
        { order: 2, title: 'My Title 2', description: 'My Description 2', icon: { pack: 'fas', name: 'server' }, tools: ['a', 'b'] },
      ],
    };
